...
def show_banner():
    ...
    banner_html = """
<div style="margin-top:16px; margin-bottom:24px; padding:20px 22px; border:1px solid #f2b8b5; border-left:7px solid #d93025; border-radius:12px; background-color:#fff4f4; color:#202124; line-height:1.75;">
<div style="font-size:21px; font-weight:800; color:#b3261e; margin-bottom:10px;">
    🚨 현재 오답노트 프로그램 점검 중입니다.
</div>
  <div style="font-size:16px;">
    기존 계정 백업 과정에서 DB 삭제 문제가 발생하여 현재 백업 시스템및 방화벽 제작하고 있습니다.<br><br>
    <b>임시 비밀번호는 <span style="color:#b3261e; font-size:18px;">sg2026</span>입니다.</b><br>
    기존 계정 이름과 임시 비밀번호로 로그인해주세요.<br><br>
    로그인 후 <b>주말에 작성했던 오답노트 번호도 다시 입력</b>해주시기 바랍니다.<br><br>
    프로그램 초창기 버그 및 오류 수정 과정에서 불편을 끼쳐드려 죄송합니다.<br>
    더 나은 프로그램을 만들기 위해 노력하겠습니다.
</div>
<div style="margin-top:14px; text-align:right; font-weight:700;">
    - 조교 tech chu-
</div>
</div>
"""
