...
def show_banner():
    ...
    <div style="
        ...
        border-left:6px solid #9f2d20;
        border-radius:14px;
        background:linear-gradient(135deg,#fffaf8 0%,#fff4f0 100%);
        color:#2f2f2f;
        font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Noto Sans KR',sans-serif;
        line-height:1.8;
        box-shadow:0 8px 24px rgba(120,60,45,0.08);
    ">
        <div style="
            font-size:22px;
            font-weight:800;
        ...
        <div style="font-size:16px; word-break:keep-all;">
            현재 SG 고등관 오답노트 앱의 보다 안정적인 운영을 위해
            시스템 점검과 데이터 백업 기능 개선 작업을 진행하고 있습니다.
            기존 계정 백업 과정에서 일부 데이터가 초기화되는 문제가 발생하여,
            현재 학생 계정을 순차적으로 복구하고 있습니다.
        </div>
        ...
        ">
            <span style="font-size:15px; font-weight:700; color:#5c4a45;">
                임시 비밀번호
            </span>
            <span style="
                margin-left:10px;
        ...
        <div style="font-size:16px; word-break:keep-all;">
            기존에 사용하던 학생 이름과 위 임시 비밀번호로 로그인해주시기 바랍니다.
            로그인 후에는 주말에 작성했던 오답번호를
            본인의 기존 작성 개수만큼 다시 입력해주세요.
            <br><br>
            계정 복구는 완료되었으나, 현재 오답번호 목록은 모두 초기화된 상태입니다.
            로그인 후에는 안전한 사용을 위해 <b>임시 비밀번호를 본인이 사용할 비밀번호로 변경</b>해주시고,
            주말에 작성했던 <b>기존 오답노트 번호도 본인의 기존 작성 개수만큼 다시 입력</b>해주시기 바랍니다.
            <br><br>
            앱 이용에 불편을 드려 진심으로 죄송합니다.
            현재 초창기 버그와 오류를 보완하고 있으며,
            앞으로는 데이터가 안전하게 보관될 수 있도록
            백업 시스템을 개선하겠습니다.
            보다 안정적이고 편리한 오답노트 앱으로 운영할 수 있도록
            지속적으로 보완하겠습니다.
        </div>
