...
XPATTERN_SCHOOL_MAP = {
    "X-패턴 공통수학2": {
        "24 강남고": [{"offset": 500, "max": 25, "exam_type": '2학기중간'}],
        "24 다운고": [{"offset": 600, "max": 16, "exam_type": '2학기중간'}],
        "24 달천고": [{"offset": 700, "max": 31, "exam_type": '2학기중간'}],
        "23 달천고": [{"offset": 2800, "max": 38, "exam_type": ''}],
        "24 동천고": [{"offset": 800, "max": 38, "exam_type": '2학기중간'}],
        "24 무거고": [{"offset": 900, "max": 34, "exam_type": '2학기중간'}],
        "24 무룡고": [{"offset": 1000, "max": 20, "exam_type": '2학기중간'}],
        "24 성신고": [{"offset": 1100, "max": 30, "exam_type": '2학기중간'}],
        "24 신정고": [{"offset": 1200, "max": 35, "exam_type": '2학기중간'}],
        "24 가온고+매곡고": [{"offset": 1300, "max": 20, "exam_type": '2학기중간'}],
        "24 중앙고+천상고": [{"offset": 1400, "max": 20, "exam_type": '2학기중간'}],
        "24 울산여고": [{"offset": 1500, "max": 20, "exam_type": '2학기중간'}],
        "23 울산여고": [{"offset": 3100, "max": 27, "exam_type": ''}],
        "24 제일고": [{"offset": 1600, "max": 20, "exam_type": '2학기중간'}],
        "24 우신고": [{"offset": 1700, "max": 20, "exam_type": '2학기중간'}],
        "24 성광여고": [{"offset": 1800, "max": 20, "exam_type": '2학기중간'}],
        "23 성광여고": [{"offset": 2900, "max": 16, "exam_type": ''}],
        "24 신선여고": [{"offset": 1900, "max": 20, "exam_type": '2학기중간'}],
        "24 대현고": [{"offset": 2000, "max": 20, "exam_type": '2학기중간'}],
        "24 삼산고": [{"offset": 2100, "max": 20, "exam_type": '2학기중간'}],
        "24 학성고": [{"offset": 2200, "max": 20, "exam_type": '2학기중간'}],
        "24 범서고+현대고": [{"offset": 2300, "max": 20, "exam_type": '2학기중간'}],
        "24 울산외고": [{"offset": 2400, "max": 20, "exam_type": '2학기중간'}],
        "23 울산외고": [{"offset": 3200, "max": 7, "exam_type": ''}],
        "24 울산고": [{"offset": 2500, "max": 20, "exam_type": '2학기중간'}],
        "23 울산고": [{"offset": 3008, "max": 20, "exam_type": ''}],
        "24 함월고": [{"offset": 2600, "max": 20, "exam_type": '2학기중간'}],
        "24 약사고": [{"offset": 2700, "max": 20, "exam_type": '2학기중간'}],
