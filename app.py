    ...
    st.markdown(
        ...
        ">
            ...
            <div style="font-size: 16px;">
                기존 계정 백업 과정에서 DB 삭제 이슈가 발생하여 현재 백업 시스템을 제작하고 있습니다.
                <br><br>
                <b>임시 비밀번호는 <span style="color:#b3261e; font-size:18px;">sg2026</span>입니다.</b>
                <br>
                기존 계정 이름과 임시 비밀번호로 로그인해주세요.
                <br><br>
                로그인 후 <b>주말에 작성했던 오답노트 번호도 다시 입력</b>해주시기 바랍니다.
                <br><br>
                프로그램 초창기 버그 및 오류 수정 과정에서 불편을 끼쳐드려 죄송합니다.
